...
namespace Mobius {
    public class HealthPickUp : Object {
        int frames = 5;
        double timer = 0f;
        double interval = 150f;
        int currentFrame = 0;
        int spriteWidth = 32;
        int spriteHeight = 32;
        ...
        public HealthPickUp(Vector2 pos) {
            ...
            texture = Game1.content.Load<Texture2D>(@"Pickups\spriteSheet-health");
            stupidFlag = false;
        ...
        public override void Draw(SpriteBatch spriteBatch) {
            spriteBatch.Draw(texture, position, sourceRect, Color.White, 0.0f, origin, 1.0f, SpriteEffects.None, 0);
        }
